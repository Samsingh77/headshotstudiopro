...
import { motion, useScroll, useSpring, useTransform, useMotionValue, useVelocity, useAnimationFrame, wrap } from "motion/react"
...
const ScrollVelocity = React.forwardRef<HTMLDivElement, ScrollVelocityProps>(
  ({ children, velocity = 5, movable = true, clamp = false, className, ...props }, ref) => {
    ...
    return (
      ...
      >
        <motion.div
          className="flex flex-row flex-nowrap whitespace-nowrap gap-4 md:gap-6"
          style={{ x }}
        >
